...
void makeEffs() {
   ...
   tch_jpsi_pp->Add("root://xrootd.unl.edu//store/group/phys_heavyions/dileptons/MC2015/pp502TeV/TTrees/OniaTree_JpsiMM_pp5p02TeV_TuneCUETP8M1_noCUT_official.root");
   TChain *tch_psi2s_pp = new TChain("hionia/myTree");
   tch_psi2s_pp->Add("root://xrootd.unl.edu//store/group/phys_heavyions/dileptons/MC2015/pp502TeV/TTrees/OniaTree_Psi2SMM_pp5p02TeV_TuneCUETP8M1_noCUT_official.root");
   TChain *tch_npjpsi_pp = new TChain("hionia/myTree");
   tch_npjpsi_pp->Add("root://xrootd.unl.edu//store/group/phys_heavyions/dileptons/MC2015/pp502TeV/TTrees/OniaTree_BJpsiMM_pp5p02TeV_TuneCUETP8M1_noCUT_official.root");
